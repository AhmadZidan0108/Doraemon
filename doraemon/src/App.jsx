...
import Hero from "./components/Hero/Hero"; // Komponen Hero
...
import EditMinuman from "./components/Dasboard/EditMinuman/EditMinuman";
    ...
    <Router>
      <div className="overflow-hidden">
        ...
        <Routes>
          ...
          <Route path="/dasboard" element={<Dasboard />} /> {/* Halaman dashboard */}
